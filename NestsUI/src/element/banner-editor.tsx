...
export default function BannerEditor({ initialColor, initialImage, onImage, onColor }: { initialColor?: string, initialImage?: string, onImage: (url?: string) => void, onColor: (color?: string) => void }) {
